...
public class MessagePopUp : MonoBehaviour
{
        ...
        string[] tmp2 =
            {
                ...
                "The red mark shows the position of your alter ego in the secon dimension. When you are over the red mark you can get entangled with the alter ego by pressing R2",
                "to move the platforms to the other dimension select the transfer gun gadget using r1/r2 and press square to use it",
                "You obtain the TRANSFER gadget!\nFor transfer an item from red inventory to the blue one or viceversa, select him and press U",
                "You obtain the DASH gadget!\nSelect him with Q/E and press U to cross energy barrier or to jump longer",
                "You obtain the GUN gadget!\nSelect him with Q/E and press U to transfer the platform  in the other dimension",
                "You obtain the TELEPORT gadget!\nSelect him with Q/E and press U to get teleported! Use right stick for change the destination"
            };
    ...
    void OnTriggerEnter(Collider o)
    {
        ...
        if (!triggered)
        {
            ...
            UIGameplayManager.Instance.displayMessage(Input.GetJoystickNames().Length > 0 ? messaggi[indice] : messaggi_key[indice], UIGameplayManager.Instance.m_UI[GameManager.Instance.m_sel_pg ? "MessageBlue" : "MessageRed"]);
