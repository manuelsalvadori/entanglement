...
[RequireComponent(typeof (ThirdPersonCharacterSaluto))]
public class ThirdPersonUserControlSaluto : MonoBehaviour
{
    private ThirdPersonCharacterSaluto m_Character; // A reference to the ThirdPersonCharacter on the object
    ...
    private void Start()
    {
        ...
        m_Character = GetComponent<ThirdPersonCharacterSaluto>();
